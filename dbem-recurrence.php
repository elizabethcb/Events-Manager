...
function dbem_insert_events_for_recurrence($recurrence) {
	...
	foreach($matching_days as $day) {
		$new_event['name'] = $recurrence['recurrence_name'];
		$new_event['notes'] = $recurrence['recurrence_notes'];
		$new_event['start_time'] = $recurrence['recurrence_start_time'];
		$new_event['end_time'] = $recurrence['recurrence_end_time'];   
		$new_event['rsvp'] = $recurrence['recurrence_rsvp'];
		$new_event['seats'] = $recurrence['recurrence_seats'];
		$new_event['location_id'] = $recurrence['location_id'];
		$new_event['recurrence_id'] = $recurrence['recurrence_id'];
		$new_event['start_date'] = date("Y-m-d", $day); 
		//print_r($new_event);
		echo "<br/>";          
